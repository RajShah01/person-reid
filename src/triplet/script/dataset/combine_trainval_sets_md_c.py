...
def combine_trainval_sets(
  ...
  for im_dir, partition_file in zip(im_dirs, partition_files):
    ...
    if(im_dir == "/content/reid_data/cuhk/images"):
      partitions['trainval_im_names'] = [x.decode('utf-8') for x in partitions['trainval_im_names']]
...
if __name__ == '__main__':
  ...
  parser.add_argument(
    '--market1501_im_dir',
    type=str,
    default=ospeu('/content/reid_data/market/images')
  )
  parser.add_argument(
    '--market1501_partition_file',
    type=str,
    default=ospeu('/content/reid_data/market/partitions.pkl')
  )
  ...
  #   default=ospeu('/content/reid_data/cuhk/images')
  # )
  # parser.add_argument(
  #   '--cuhk03_partition_file',
  #   type=str,
  #   # Remember to select the detected or labeled set.
  #   default=ospeu('/content/reid_data/cuhk/partitions_cuhk.pkl')
  # )

  parser.add_argument(
    '--duke_im_dir',
    type=str,
    default=ospeu('/content/reid_data/duke/images'))
  parser.add_argument(
    '--duke_partition_file',
    type=str,
    default=ospeu('/content/reid_data/duke/partitions_duke.pkl')
  )

  parser.add_argument(
    '--save_dir',
    type=str,
    default=ospeu('/content/reid_data')
  )
